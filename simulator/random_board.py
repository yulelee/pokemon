...
class random_board():
    ...
    def __init__(self, board_size, spawn_frequency = 2, verbose = False):
    ...
    def _random_nearby_positions(self, current_position, num_nearby):
        ...
        def _axis_within_board(current):
            return int(max(min(random.gauss(current, 2), self.board_size), 0))
    ...
    def spend_time(self):
        ...
        if self.time % self.spawn_frequency == 0:
            ...
            spawn_center = self._random_position()
